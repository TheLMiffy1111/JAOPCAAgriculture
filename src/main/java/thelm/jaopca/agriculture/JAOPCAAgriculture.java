...
@Mod(
		...
		dependencies = "required-before:jaopca@[1.12.2-2.2.8.89,);after:mysticalagriculture;after:mysticalagradditions;after:agricraft@[2.12.0,)"
		)
public class JAOPCAAgriculture {
	...
	public static final String VERSION = "1.12.2-1.2.1.17";
