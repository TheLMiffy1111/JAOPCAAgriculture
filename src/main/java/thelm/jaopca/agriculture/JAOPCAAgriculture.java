...
@Mod(
		...
		dependencies = "required-before:jaopca@[1.12.2-2.1.6.71,);after:mysticalagriculture;after:mysticalagradditions;after:agricraft"
		)
public class JAOPCAAgriculture {
	...
	public static final String VERSION = "1.12.2-1.2.1.7";
