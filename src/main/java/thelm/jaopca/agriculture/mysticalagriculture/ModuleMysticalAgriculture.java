...
public class ModuleMysticalAgriculture extends ModuleBase {
	...
	static {
		BLACKLIST = Lists.<String>newArrayList(
				...
				"RedstoneAlloy", "ConductiveIron", "Soularium", "DarkSteel", "PulsatingIron", "EnergeticAlloy", "VibrantAlloy", "EndSteel", "Manasteel", "Elementium",
				"Terrasteel", "Quicksilver", "Thaumium", "Void", "Dawnstone", "Osmium", "RefinedGlowstone", "RefinedObsidian", "Aquarium", "Coldiron", "Starsteel",
				"Adamantine", "Apatite", "Electrotine", "Alumite", "Steeleaf", "Ironwood", "Knightmetal", "Fiery", "MeteoricIron", "Desh", "Coralium", "Abyssalnite",
				"Dreadium", "Syrmorite", "Octine", "Valonite", "Thorium", "Boron", "Lithium", "Magnesium", "BlackQuartz", "Vinteum", "Chimerite", "BlueTopaz", "Moonstone",
