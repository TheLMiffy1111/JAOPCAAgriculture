...
public class ModuleMysticalAgriculture extends ModuleBase {
	...
	public void init() {
		...
		for(IOreEntry entry : JAOPCAApi.ENTRY_NAME_TO_ORES_MAP.get("crux")) {
			...
			GameRegistry.addRecipe(new ShapedOreRecipe(Utils.getOreStack("crux", entry, 1), new Object[] {
					"MEM",
					"SDS",
					"MEM",
					'M', "essenceSupremium",
	...
	public static Object getEssence(int tier) {
		...
		case 6:
			...
			return new ItemStack(itemInsanium, 1, 0);
		}
	}
	...
	public static ItemStack getCraftingSeeds(int tier) {
		...
		switch(tier) {
		case 1:
			return new ItemStack(ModItems.itemTier1CraftingSeed);
		case 2:
			return new ItemStack(ModItems.itemTier2CraftingSeed);
		case 3:
		default:
			return new ItemStack(ModItems.itemTier3CraftingSeed);
		case 4:
			return new ItemStack(ModItems.itemTier4CraftingSeed);
		case 5:
			return new ItemStack(ModItems.itemTier5CraftingSeed);
		case 6:
			Item itemInsanium = Item.REGISTRY.getObject(new ResourceLocation("mysticalagradditions", "insanium"));
	...
	public void onBonemealEvent(BonemealEvent event) {
		...
		if(state.getBlock() instanceof BlockCropsBase) {
			...
			if(player.getHeldItemMainhand() != null && player.getHeldItemMainhand().getItem() == ModItems.itemFertilizedEssence ||
					player.getHeldItemOffhand() != null && player.getHeldItemOffhand().getItem() == ModItems.itemFertilizedEssence) {
