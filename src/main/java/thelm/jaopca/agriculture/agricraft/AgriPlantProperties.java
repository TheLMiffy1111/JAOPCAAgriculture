...
public class AgriPlantProperties implements IProperties {
	...
	public AgriPlantProperties setGrowthChanceFuncFunc(ToDoubleFunction<IOreEntry> value) {
	...
	public AgriPlantProperties setConditions(List<Pair<String, Boolean>>... value) {
